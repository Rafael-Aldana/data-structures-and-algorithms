...
const addPurchases = (arr) => arr.reduce((accumulator, currentValue) => {
...
const countNumberOfElements = (arr) => arr.reduce((accumulator, currentValue) => accumulator + 1, 0);
...
const returnNames = (arr) => arr.reduce((accumulator, nameData) => {
  accumulator.push(nameData.name)
  return accumulator;
} ,[]);
